...
void RLRedeemLayer::onExitTransitionDidStart() {
    CCLayer::onExitTransitionDidStart();
    GameManager::sharedState()->playMenuMusic();
}

void RLRedeemLayer::onEnterTransitionDidFinish() {
...
void RLRedeemLayer::onRedeem(CCObject* sender) {
    ...
    m_textLabel = CCLabelBMFont::create("Let's consult the Cosmos", "bigFont.fnt");
...
void RLRedeemLayer::startRedeemRequest() {
    ...
    if (m_rewardInput->getString() == "SPIRE" && !Mod::get()->getSavedValue<bool>("hasCode")) {
        ...
        DialogObject* dialog2 = DialogObject::create("The Oracle", "Now seek your <cg>words</c> outside of this place, <cr>it</c> is <cy>waiting.</c>", 0, 1.f, false, ccWHITE);
