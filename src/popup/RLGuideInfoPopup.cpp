...
void RLGuideInfoPopup::onLayouts(CCObject* sender) {
    MDPopup::create(
        ...
        "Alternatively, creators can put their focus more on the playability aspect, primarily delivering interesting player movements and engaging gameplay without fully relying on sync and note representation, as long as the **pacing (usage of speed portals) still matches the song perfectly**.\n\n"
        ...
        "There are 14 total reasons why a layout should not be rated in Rated Layouts, all available in [Non-Rateable Layouts (aka NRL)](https://discord.com/channels/1439944272102162442/1482046209974603877)\n\n"
...
void RLGuideInfoPopup::onStandards(CCObject* sender) {
    MDPopup::create(
        ...
        "Layouts are focused entirely on base gameplay and structuring, and base gameplay is judged in a completely different way in the aspects of idea+execution, song representation, and playability.\n\n"
        ...
        "In contrast to regular layouts, auto layouts do not require any player input and are built specifically for the viewing experience. Because of this, Auto layouts are evaluated in a slightly different way, only prioritizing sync, pacing, and note representation.\n\n"
        ...
        "The goal is to make sure Rated Layouts are much more tolerable for players to play, while rewarding creators for their talent and mastery in gameplay skills.\n\n"
...
void RLGuideInfoPopup::onOthers(CCObject* sender) {
    MDPopup::create(
        ...
        "A **Robtop-styled** level is similar to the old main levels: Stereo Madness, Back on Track, Polargeist, Dry Out, Can't Let Go, etc. A major indicator is abusing square/rectangle structures that only have default checker-like blocks inside, alongside having a lot of basic, ground-level fundamentals tied together without any sync (i.e. regular spike jumps and singular orb click).\n\n"
